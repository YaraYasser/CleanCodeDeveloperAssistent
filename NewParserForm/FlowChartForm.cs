...
namespace NewParserForm
{
    public partial class FlowChartForm : Form
    {
        ...
        public bool last_if_node = false;
        public bool is_while_stat2 = false;
        ...
        /// <summary>
        public Node last_if_child_parent = new Node();
        public int last_if_child_parent_counter = 0;
        /// </summary>
        ...
        public FlowChartForm()
        {
            ...
            TxtBox_InputCode.Text=accessor.getCode();
        ...
        public void draw_statment(int pos_x, int pos_y)
        {
            ...
            SolidBrush brushz = new SolidBrush(Color.Blue);
            panelGraphics.DrawRectangle(Pens.Black, _rectangle);
            panelGraphics.FillRectangle(brushz, _rectangle);
            ...
            if (changedsize == false)
            {
                ...
                panelGraphics.DrawString(drawString, FindFont(panelGraphics, drawString, _rectangle.Size, drawFont), drawBrush2, _rectangle, stringFormat);

            }

            else
            {
                panelGraphics.DrawString(drawString, drawFont, drawBrush2, _rectangle, stringFormat);
            }
            /*********************************************************************/
        ...
        public void draw_condition(Point pos1, Point pos2, Point pos3, Point pos4)
        {
            ...
            //Graphics g = panel1.CreateGraphics();
            panelGraphics.DrawPolygon(Pens.Red, points);
            SolidBrush fill = new SolidBrush(Color.Red);
            panelGraphics.FillPolygon(fill, points);
            ...
            drawString = stringItem;
            drawString = dictionary(drawString);
            panelGraphics.DrawString(drawString, drawFont, drawBrush2,/*posx+75*/pos1.X, posy + 50, stringFormat);
            polygon_points[0].Y += 125;
            polygon_points[1].Y += 125;
            polygon_points[3].Y += 125;
            polygon_points[2].Y += 125;
        ...
        public void draw_loop(Point pos1, Point pos2, Point pos3, Point pos4)
        {
            ...
            Point[] points = { pos1, pos2, pos3, pos4 };
            //Graphics g = panel1.CreateGraphics();
            panelGraphics.DrawPolygon(Pens.Purple, points);
            ...
            drawString = stringItem;
            drawString = dictionary(drawString);
            panelGraphics.DrawString(drawString, drawFont, drawBrush2,/* posx + 75, posy + 50*/pos1.X, posy + 50, stringFormat);
            polygon_points[0].Y += 125;
            polygon_points[1].Y += 125;
            polygon_points[3].Y += 125;
            polygon_points[2].Y += 125;
        ...
        public void start()
        {
            ...
            panelGraphics.FillEllipse(fill, 300, 10, 150, 50);
            drawString = "Start";
            StringFormat stringFormat = new StringFormat();
            stringFormat.Alignment = StringAlignment.Center;
            stringFormat.LineAlignment = StringAlignment.Center;

            panelGraphics.DrawString(drawString, drawFont, drawBrush2, posx + 75, posy + 25, stringFormat);
        ...
        public void end()
        {
            ...
            SolidBrush fill = new SolidBrush(Color.Yellow);
            panelGraphics.FillEllipse(fill, posx, posy, 150, 50);
            StringFormat stringFormat = new StringFormat();
            stringFormat.Alignment = StringAlignment.Center;
            stringFormat.LineAlignment = StringAlignment.Center;
            drawString = "End";
            ...
            for (int i = 0; i < x.Count; i++)
            {
                ...
                if (x[i].Type == StatementTypes.Condition)
                {
                    ...
                    if (x[i].FalseChildren.Count != 0)
                    {
                        ...
                        ifdummy = true;
                        //if (!(islast_position_of_y == true && IS_child==true)) 
                        //{
                            last_if_child_parent = x[i];
                        last_if_child_parent_counter++;
                       // }
                        drawing(x[i].FalseChildren, local_posx, local_right_posx);

                        ///rbna yostor 3al last if child parent 
                        //last_if_child_parent = new Node();
                        ///

                        //end_items.Add(new Point(local_posx, posy)); //deh moshkla kberaaaaaaaaaaaaaaaaaaaa3aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa3
                    ...
                    else if (x[i].FalseChildren.Count == 0 && condchild == false)
                    {
                        ...
                        if (IS_child == true && ifdummy == true)
                        {
                            ///bgrb
                            draw_arrow(local_posx + 75, polygon_points[2].Y - differnce, local_posx + 75, posy +differnce+ (children_number(last_if_child_parent.TrueChildren) * 125), "False");
                            last_if_child_parent_counter = 0;
                            ///
                        }
                        else
                        {
                    ...
                    else if (x[i].FalseChildren.Count == 0 && condchild == true && is_forz_child == true)
                    {
                        ...
                        if (i == x.Count - 1)
                        {
                            if (local_posx == local_right_posx)
                            {
                                end_items.Add(new Point(local_right_posx - 175 - (_rectangle.Width / 2), polygon_points[2].Y - (_rectangle.Height)));
                            }
                            else if (local_posx == 300) {
                                draw_arrow(local_posx + 75, polygon_points[2].Y - differnce, local_posx + 75, posy + (children_number(x[i].TrueChildren) * 125), "False");
                            }
                            else if (is_forz_child == true&&ifdummy==true&&islast_position_of_y==true)
                            {
                                draw_arrow(local_posx + 75, (polygon_points[2].Y - differnce), (local_posx + 75) , polygon_points[2].Y + differnce - _rectangle.Height+ (children_number(last_if_child_parent.TrueChildren)*125), "False");
                            }
                            else {
                    ...
                    if (x[i].TrueChildren.Count != 0)
                    {
                        ...
                        if (is_forz_child == false && condchild == true || islastifchild == true)
                        {
                            ...
                            else if (is_while_stat2 == true) { }
                            else if (local_posx < posx + 250)
                            {
                                end_items.Add(new Point(local_right_posx, posy));
                            }
                        }
                        /*else if (is_forz_child == false && condchild == true || islastifchild == false)
                        {
                            end_items.Add(new Point(local_posx, posy));
                        }*/

                        else if (is_forz_child == true && condchild == false || islastifchild == false) {
                ...
                else if (x[i].Type == StatementTypes.ForLoop /*&& dummy == false*/)
                {
                    ...
                    if (i != x.Count - 1)
                    {
                        ...
                        if (x[i].FalseChildren.Count == 0 && is_condition_child == true && is_if_child == true)
                        {
                            if (i == x.Count - 1)
                            {
                                draw_arrow(local_posx + 75, polygon_points[2].Y - differnce, posx + 75, polygon_points[2].Y - differnce, "");
                            }
                            else if (i != x.Count - 1)
                            {
                                draw_arrow(local_posx + 75, polygon_points[2].Y - differnce, /*posx*/ local_posx + 75, (posy) + (children_number(x[i].TrueChildren) * 125), ""/* + differnce*/);
                    ...
                    else if (i == x.Count - 1)
                    {
                        ...
                        {
                            draw_arrow(local_posx + 75, polygon_points[2].Y - differnce, (local_posx + 75) - 250, polygon_points[2].Y - differnce, "");
                        }
                ...
                else if (x[i].Type == StatementTypes.WhileLoop/* && dummy == true*/)
                {
                    ...
                    if (i != x.Count - 1)
                    {
                        ...
                        if (x[i].FalseChildren.Count == 0)
                        {
                            ...
                            draw_arrow(local_posx + 75, polygon_points[2].Y - differnce, local_posx + 75, posy + (children_number(x[i].TrueChildren) * 125), "");
                            incrementer = 0;
...

                    {
                        ...
                        if (i == x.Count - 1)
                        {
                            ...
                            if (IS_child == true)
                            {
                                ...
                                if (ifdummy == true)
                                {
                                    if (is_while_stat == true||is_while_stat2==true)
                                    {
                                    ...
                                    else if (is_forz_child == true && condchild == true || islastifchild == true)
                                    {
                                        if (is_IF_gogo == true)
                                        {
                                            ...
                                            try
                                            {
                                                if (last_if_child_parent.TrueChildren.Count != 0 && is_IF_false_child==true /**&& /*i!=x.Count-1*/)
                                                {
                                                    if (last_if_child_parent_counter == 1)
                                                    {
                                                        draw_arrow(_rectangle.X + (_rectangle.Width / 2), _rectangle.Y + _rectangle.Height, local_posx + (_rectangle.Width / 2), posy + (children_number(last_if_child_parent.TrueChildren) * 125), "");
                                                    }
                                                    else if (last_if_child_parent_counter > 1)
                                                    {
                                                        draw_arrow(_rectangle.X + (_rectangle.Width / 2), _rectangle.Y + _rectangle.Height, local_posx + (_rectangle.Width / 2),differnce+ posy + (children_number(last_if_child_parent.TrueChildren) * 125), "");
                                                    }
                                                    last_if_child_parent_counter = 0;
                                                    }
                                            }
                                        ...
                                        {
                                            if (last_if_node == true&&local_posx>posx+250) {
                                                draw_arrow(local_posx + 75, (_rectangle.Y + _rectangle.Height), ((local_posx + 75)) - 250*2, (_rectangle.Y + _rectangle.Height), "");
                                            }

                                            else if (last_if_node == true)
                                            {

                                                end_items.Add(new Point(local_right_posx - 175 - (_rectangle.Width / 2), (_rectangle.Y + differnce)));
                                            }
                                            else
                                            {
                                                draw_arrow(local_posx + 75, (_rectangle.Y + _rectangle.Height), (local_posx + 75) - 250, (_rectangle.Y + _rectangle.Height), "");
                                    ...
                                    else if (is_IF_false_child == true)
                                    {
                                        ...
                                        if (i == x.Count - 1)
                                        {
                                            if (last_if_child_parent_counter == 1)
                                            {
                                                draw_arrow(_rectangle.X + _rectangle.Width / 2, (_rectangle.Y + _rectangle.Height), _rectangle.X + _rectangle.Width / 2, _rectangle.Y + differnce + (125 * children_number(last_if_child_parent.TrueChildren)), "");
                                            }
                                            else if (last_if_child_parent_counter > 1)
                                            {
                                                draw_arrow(local_posx + 75, polygon_points[2].Y - differnce - 49, local_posx + 75, posy + differnce + (children_number(last_if_child_parent.TrueChildren) * 125), "False");
                                            }
                                                incrementer = 0;
                                            last_if_child_parent_counter = 0;
                                        }
                                        ///
                                       //end_items.Add(new Point(local_right_posx - 100 - (_rectangle.Width / 2), (_rectangle.Y + differnce)));
                                        is_IF_false_child = false;
                                    }
                            ...
                            {
                                if (is_forz_child==true&&condchild==true) {
                                    loop_parentz.Add(new Point(_rectangle.X + (_rectangle.Width), _rectangle.Y + (_rectangle.Height / 2)));
                                    loop_true_arrows(loop_parentz, loop_childz, "");
                                }
                                else if (condchild==true) { }
                                else {
                                    draw_arrow(_rectangle.X + (_rectangle.Width / 2), _rectangle.Y + _rectangle.Height, local_posx + (_rectangle.Width / 2), posy, "");
                                }
                            }
        ...
        private void DrawFlowChart()
        {
            ...
            try
            {
                if (tempf.FunctionName.ToLower()== "main")
                {
            ...
            catch { MessageBox.Show("ERROR You have entered a code that doesn't contain Main function"); }
       ...
       /* private void TxtBox_InputCode_TextChanged(object sender, EventArgs e)
        ...
        private void FlowChartForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
